  ...
  return (
    <div className='w-full h-full max-w-5xl flex flex-col min-h-screen items-start space-y-4 py-[80px]'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-x-2 w-full'>
        <Cards  image='steto' title='Quick Examination' description='We focus on ergonomics and meeting you where you work. Its only a keystroke away'/>
        <Cards  image='szuri' title='Online Appoinment' description='We focus on ergonomics and meeting you where you work. Its only a keystroke away'/>
        <Cards  image='fityula' title='Emergency Case' description='We focus on ergonomics and meeting you where you work. Its only a keystroke away'/>
      </div>
    </div>
  )
}
